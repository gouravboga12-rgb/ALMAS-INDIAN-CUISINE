import{l as e,u as t}from"./main-wOO9Zp33.js";var n=t(e(),1);async function r(){try{let e=await fetch(`/api/qr-menu`);if(!e.ok){a();return}let t=await e.json(),n=document.getElementById(`dynamic-category-nav`);n&&(n.innerHTML=t.categories.sort((e,t)=>e.order-t.order).map(e=>`
