import{c as e,l as t,o as n}from"./main-DS7Wfilc.js";var r=t(e(),1);async function i(){try{let e=await fetch(`/api/menu`);if(!e.ok){a();return}let t=await e.json(),n=document.getElementById(`dynamic-mobile-quick-nav`);n&&(n.innerHTML=`
          ...
          `);let r=document.getElementById(`dynamic-category-sidebar`);r&&(r.innerHTML=`
            ...
            `).join(``)}
          `);let i={soups:`Broths & slow-simmered warmth`,appetizers:`Bold starters & sharing plates`,tandoor:`Clay oven crafted`,"tandoor-treasures":`Clay oven crafted`,mains:`Curries & slow-cooked gravies`,biryani:`Muglai saffron standard`,mandi:`Arabic smoked rice`,beverages:`Teas & cold mocktails`,chinese:`Wok tossed`,momo:`Steamed or fried`,breads:`Tandoor baked`,desserts:`Sweet endings`},o=document.getElementById(`dynamic-products-container`);if(o){let e=``;t.categories.sort((e,t)=>e.order-t.order).forEach(n=>{let r=t.products.filter(e=>e.category===n.name);if(r.length===0)return;let a=i[n.id]||`Freshly prepared`;e+=`
